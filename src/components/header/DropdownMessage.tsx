    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      <li className="relative">
        <Link
          ...
          className="h-8.5 w-8.5 border-stroke dark:border-strokedark dark:bg-meta-4 relative flex items-center justify-center rounded-full border-[0.5px] bg-gray hover:text-primary dark:text-white"
          to="#"
        >
          <span
